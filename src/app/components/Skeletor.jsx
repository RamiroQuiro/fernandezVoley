...
export default function Skeletor() {
  return (
    ...
    <div className="flex flex-col m-8 rounded shadow-md w-full bg-gray-400 animate-pulse h-1/2">
      <div className="h-full rounded-t bg-gray-700"></div>
      <div className="flex-1 px-4 py-8 space-y-4 sm:p-8 animate-pulse bg-gray-100">
        <div className="w-full h-6 rounded animate-pulse bg-gray-700"></div>
        <div className="w-3/4 h-6 rounded animate-pulse bg-gray-700"></div>
      </div>
    </div>
    </section>
  );
