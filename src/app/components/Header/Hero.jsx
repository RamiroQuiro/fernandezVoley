...
export default function Hero() {
  return (
    <section className="h-full w-full relative">
      ...
      <div className="bg-gradient-to-b from-gray-800/80 backdrop-blur-sm via-gray-800/50 to-transparent md:h-[90vh] h-full z-30 relative">
        <div className="container flex flex-col items-center px-4 md:py-32 pt-28 mx-auto text-center">
