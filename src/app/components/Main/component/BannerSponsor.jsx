...
export default function BannerSponsor() {
  return (
    <section className="w-full py-10 px-6 flex flex-col md:flex-row items-center justify-center mx-auto bg-gray-100 text-gray-700">
      <div className="  my-10 mx-auto h-full text-center items-center justify-around gap-5 flex flex-col md:w-1/2 w-full">
        <span className="font-medium text-2xl text-orange-500/80">Pagina creada por</span>
