...
export default function InputFileGaleria() {
  ...
  return (
    <>
      <div className="border rounded-lg  w-full md:w-2/3 mx-auto  mb-10 flex items-center justify-between my-8 bg-white">
        <label
          htmlFor="galeria"
        ...
        <button
          ...
          className="cursor-pointer bg-primary-100/50 hover:bg-primary-100 duration-200 p-2 rounded-r-lg text-gray-700 hover:bg-orange-200 font-semibold text-sm"
        >
          subir
        </button>
      </div>
